import WindSpeedIcon from "@/public/svgs/wind-speed.svg";
...
export default function WindSpeed({ windSpeed, windDegree }: WindSpeedProps) {
    return (
        <div id="wind-speed" className="min-w-32 min-h-32 p-6 flex flex-col justify-between bg-neutral-900 border border-neutral-800 rounded-2xl">
            ...
            <div className="relative w-24 h-24 mx-auto flex justify-center items-center">
                ...
                <svg
                    ...
                    className="absolute transition-transform ease-in-out will-change-transform"
                >
